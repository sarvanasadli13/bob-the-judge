...
SERVICES = [
    {"name": "Legacy Bank",  "cmd": [sys.executable, "-m", "uvicorn", "services.legacy_bank:app",  "--port", "8001", "--log-level", "error"], "health": "http://localhost:8001/health"},
    {"name": "Modern Bank",  "cmd": [sys.executable, "-m", "uvicorn", "services.modern_bank:app",  "--port", "8002", "--log-level", "error"], "health": "http://localhost:8002/health"},
]
